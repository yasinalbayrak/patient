...
<div class="menu">
<div class="back"> <a href= "http://localhost/patient/rtdb/support.html"><i class="fa fa-chevron-left"></i> <img src="https://i.imgur.com/DY6gND0.png" draggable="false"/> </a> </div>
...
<?php
	...
	if($fetch_data != null)
	{
		$keys = array_keys($fetch_data);
		if($keys != null)
		{
			for ($i = 0; $i < count($keys); $i++){
				$chat_msg = $fetch_data[$keys[$i]];
