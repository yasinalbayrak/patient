...
<tr> <th> DOCTOR ID </th> <th>  BRANCH CODE </th><th> HOSPITAL ID </th> <th> SINCE </th><th> UNTIL </th><th> WORK LOG NUMBER </th></tr> 
<?php
...
if(!empty($_POST))
{
    ...
    $sql_statement = "SELECT * FROM doctor_worksin WHERE 
        since >= '$since'
        AND until <= '$until'
    ...
    if(empty($_POST['until']) )
        ...
        SELECT * FROM doctor_worksin WHERE 
        since >= '$since'
        AND ISNULL(until) 
