...
<body>    
    <form action="deletion_w.php" method="POST" accept-charset="utf-8"> 
        ...
        <h1>
            ...
            ?>
            <br><br><br>
            Select the work log number to be deleted
            <select name="worlog_id">

            <?php
            
            include "config.php";
            
            $sql_command = "SELECT DISTINCT(workLog_no) FROM doctor_worksin";
            
            $myresult = mysqli_query($hospital_db, $sql_command);
            echo "<option value='' disabled selected hidden> Select an id </option>";
            while($id_rows = mysqli_fetch_assoc($myresult))
            {
                $id = $id_rows['workLog_no'];
        ...
        <div class="container">
      <a href="index_doctors_worksin.php" class="btn">Go back to main page</a>
    </div>
    </form>
</body>
</html>
