  ...
  <article>
    <div class="article-wrapper">
      ...
      <div class="article-body">
        <h2>Doctors</h2>
        <p>
            Inserting, deleting and filtering Doctors' working informations.
        </p>
        <a href="http://localhost/patient/doctors_workin/index_doctors_worksin.php" class="read-more">
  ...
  <article>
    ...
    <div class="article-wrapper">
      ...
      <div class="article-body">
        <h2>Nurse</h2>
        <p>
            Inserting, deleting and filtering Nurses' working informations.
        </p>
        <a href="http://localhost/patient/nurses_workin/index_nurses_worksin.php" class="read-more">
          Go <span class="sr-only">about this is some title</span>
          <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
          </svg>
