...
if (isset($_POST['n_id']) and isset($_POST['branch_code'])  and isset($_POST['hospital_id']) and(! empty($_POST['since']) and isset($_POST['since']))) 
{ 
...
//Warning: mysqli_num_rows() expects parameter 1 to be mysqli_result, boolean given in C:\xampp\htdocs\patient\doctors_workin\insertion_w.php on line 27
    ...
    else 
    {
        ...
        if($until != NULL)
            ...
            $sql_statement = "INSERT into nurse_worksin(n_id,branch_code,hospital_id,since,until)
        ...
        if($result == 1)
        {
            ...
            $newURL = "index_nurses_worksin.php";
