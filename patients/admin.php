...
<h1>
            <br><br><h3 style="color: rgb(6, 123, 248);text-shadow:3px 3px rgb(96, 187, 187);font-weight: 1000;font-size: 40px;padding-bottom:0px;">Delete a Patient</h3>
            <?php 
            include "patients.php";
            ?>
            <br><br><br>
            Select the patient id to delete a patient
            <br><select name="p_id">
            ...
            echo "<option value='' disabled selected hidden> Select a patient id </option>";
